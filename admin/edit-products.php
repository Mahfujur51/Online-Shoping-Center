...
if(strlen($_SESSION['alogin'])==0)
{
	...
	if(isset($_POST['submit']))
	{
		...
		$upsql="UPDATE tbl_product SET catid='$catid',subcatid='$subcatid',productname='$productname',productcompany='$productcompany',productprice='$productprice',productpricebeforediscount='$productpricebeforediscount',pdescription='$pdescription',shippingcharge='$shippingcharge',productavailability='productavailability' WHERE id='$pid'";
