...
$t1="23:59:59";
$to=date('Y-m-d')." ".$t1;
 $result = mysqli_query($con,"SELECT * FROM tbl_oders where orderdate Between '$from' and '$to'");
...
?>
									...
									<li>
										...
										<?php	
	$status='Delivered';									 
$ret = mysqli_query($con,"SELECT * FROM tbl_oders where oderstatus!='$status' || oderstatus is null ");
...
<?php } ?>
								...
								<?php	
	$status='Delivered';									 
$rt = mysqli_query($con,"SELECT * FROM tbl_oders where oderstatus='$status'");
