...
if(isset($_POST['ordersubmit']))
{
	...
	if(strlen($_SESSION['login'])==0)
	{
		...
		foreach($value as $qty=> $val34){
			mysqli_query($con,"insert into tbl_oders(userid,productid,quantity) values('".$_SESSION['id']."','$qty','$val34')");
													...
													<tr>
														...
														<td class="cart-image">
															<a class="entry-thumbnail" href="detail.html">
																<img src="admin/productimage/<?php echo $row['id'];?>/<?php echo $row['productimage1'];?>" alt="" width="114" height="146">
															</a>
														</td>
														<td class="cart-product-name-info">
															...
															<div class="row">
																...
																<div class="col-sm-8">
																	<?php $rt=mysqli_query($con,"SELECT * FROM tbl_productreview where proid='$pd'");
											...
											<tr>
												<td>
													<div class="form-group">
														<?php $qry=mysqli_query($con,"SELECT * FROM tbl_user where id='".$_SESSION['id']."'");
