...
if(isset($_GET['pid']) && $_GET['action']=="wishlist" ){
	...
	{
		$wsql="INSERT INTO tbl_wishlist(userid,productid)VALUES('$userid','$pid')";
...
if(isset($_POST['submit']))
{
	...
	mysqli_query($con,"INSERT INTO tbl_productreview(proid,quality,price,value,name,summary,review) VALUES('$pid','$quality','$price','$value','$name','$summary','$review')");
}
						...
						<div class="row  wow fadeInUp">
							...
							<div class='col-sm-6 col-md-7 product-info-block'>
								<div class="product-info">
									...
									<?php $rt=mysqli_query($con,"SELECT * FROM tbl_productreview where proid='$pid'");
						...
						<div class="row">
									...
									<div id="review" class="tab-pane">
										<div class="product-tab">
											...
											<div class="product-reviews">
												...
												<?php $qry=mysqli_query($con,"SELECT * FROM tbl_productreview where proid='$pid'");
							...
							<section class="section featured-product wow fadeInUp">
								...
								<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
									...
									<?php 
									$qry=mysqli_query($con,"SELECT * FROM tbl_product WHERE subcatid='$subcid' and catid='$cid'");
											...
											<div class="products">
												<div class="product">		
													<div class="product-image">
														<div class="image">
															<a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimage/<?php echo htmlentities($rw['id']);?>/<?php echo htmlentities($rw['productimage1']);?>" width="150" height="240" alt=""></a>
														</div><!-- /.image -->			
