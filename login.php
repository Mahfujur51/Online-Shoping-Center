...
if(isset($_POST['login']))
{
	...
	if($num>0)
	{
		...
		$statatus=1;
		$log=mysqli_query($con,"INSERT INTO tbl_userlog(useremail,userip,statatus) values('".$_SESSION['login']."','$userip','$statatus')");
	...
	else
	{
		...
		$userip=$_SERVER['REMOTE_ADDR'];
		$statatus=0;
		$log=mysqli_query($con,"INSERT INTO tbl_userlog(useremail,userip,statatus) values('$email','$userip','$statatus')");
		if ($log) {
