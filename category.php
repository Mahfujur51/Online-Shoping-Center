...
if(isset($_GET['wid'])){
	...
	{
		$wsql="INSERT INTO tbl_wishlist(userid,productid)VALUES('$userid','$productid')";
							...
							<div class="item">	
								...
								<div class="container-fluid">
									<div class="caption vertical-top text-left">
										...
										<?php 
										$sql=mysqli_query($con,"SELECT * FROM tbl_catagory WHERE id='$cid'");
										while($row=mysqli_fetch_array($sql))
										{
											?>
...
<div class="row">									
<?php
$ret=mysqli_query($con,"SELECT * FROM tbl_product WHERE catid='$cid'");
...
<li class="add-cart-button btn-group">
	...
	<li class="lnk wishlist">
		<a class="add-to-cart" href="category.php?wid=<?php echo htmlentities($row['id'])?>" title="Wishlist">
