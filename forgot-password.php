...
if(isset($_POST['change']))
{
	...
	$query=mysqli_query($con,"SELECT * FROM tbl_user WHERE email='$email' AND contactno='$contactno'");
	$num=mysqli_fetch_array($query);
	if($num>0)
	{
		$csql="UPDATE tbl_user SET password='$password' WHERE email='$email' AND contactno='$contactno'";
		$cquery=mysqli_query($con,$csql);
		if ($cquery) {
			header("location:forgot-password.php");
			$_SESSION['errmsg']="Password Changed Successfully";
		}else{
			$_SESSION['errmsg']="Password NOT Changed Successfully";
		}
						...
						<div class="col-md-6 col-sm-6 sign-in">
							...
							<form class="register-form outer-top-xs" name="register" method="post">
								...
								<div class="form-group">
									...
									<input type="text" name="contactno" class="form-control unicase-form-control text-input" id="contact" required>
								</div>
								<div class="form-group">
